...
from src.util.stationarization import stationarize
...
class BitcoinTradingEnv(gym.Env):
    ...
    def __init__(self, df, reward_func='sortino', initial_balance=10000, commission=0.0025, forecast_len=10, confidence_interval=0.95):
        """
        :param df:
    ...
    def _getReward(self):
        ...
        if self.reward_func in ['sortino', 'calmar', 'omega']:
            ...
            #print("in fancy strats reward: " + str(reward))
